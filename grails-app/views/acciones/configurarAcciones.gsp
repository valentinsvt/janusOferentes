<%@ page import="janus.seguridad.Prfl; janus.seguridad.Accn;janus.seguridad.Tpac;" contentType="text/html;charset=UTF-8" %>
<html>
<head>
...
<div>
                ...
                <table style="width: 600px;" id="tabla_${mod.id}">
                    ...
                    <g:each in="${Accn.findAllByModuloAndTipo(mod,Tpac.get(tipo_tpac),[sort:'control'])}" var="accn"
                        ...
                        <tr class="${(j % 2) == 0 ? 'odd' : 'even'}">
                            ...
                            <td>${accn.control}</td>
                            <td><g:select from="${janus.seguridad.Tpac.list()}" optionKey="id" accn="${accn.id}"
                                          name="accn"
    ...
    <div id="" class="toolbar ui-widget-header ui-corner-all">
        ...
        <g:select optionKey="id" from="${janus.seguridad.Modulo.list()}" name="modulo" value="${modulo?.id}"></g:select>
