...
<html>
    ...
    <body>
                ...
                <g:each in="${tipoProcedimientoInstanceList}" status="i" var="tipoProcedimientoInstance">
                    <tr>
                        ...
                        <td>
                            ...
                            <a class="btn btn-small btn-edit btn-ajax" href="#" rel="tooltip" title="Editar" data-id="${tipoProcedimientoInstance.id}">
                                <i class="icon-pencil icon-large"></i>
                            </a>

                            <a class="btn btn-small btn-delete" href="#" rel="tooltip" title="Eliminar" data-id="${tipoProcedimientoInstance.id}">
        ...
        <div class="modal hide fade" id="modal-TipoProcedimiento">
        ...
        <script type="text/javascript">
            ...
            function submitForm(btn) {
                if ($("#frmSave-TipoProcedimiento").valid()) {
                    btn.replaceWith(spinner);
                }
                $("#frmSave-TipoProcedimiento").submit();
            }
            ...
            $(function () {
                ...
                $(".btn-new").click(function () {
                    $.ajax({
                        ...
                        success : function (msg) {
                            ...
                            $("#modalTitle").html("Crear Tipo Procedimiento");
                            $("#modalBody").html(msg);
                            $("#modalFooter").html("").append(btnOk).append(btnSave);
                            $("#modal-TipoProcedimiento").modal("show");
                        }
                    });
                    return false;
                }); //click btn new
                ...
                $(".btn-edit").click(function () {
                    ...
                    $.ajax({
                        ...
                        success : function (msg) {
                            ...
                            $("#modalTitle").html("Editar Tipo Procedimiento");
                            $("#modalBody").html(msg);
                            $("#modalFooter").html("").append(btnOk).append(btnSave);
                            $("#modal-TipoProcedimiento").modal("show");
                        }
                ...
                $(".btn-show").click(function () {
                    ...
                    $.ajax({
                        ...
                        success : function (msg) {
                            ...
                            $("#modalTitle").html("Ver Tipo Procedimiento");
                            $("#modalBody").html(msg);
                ...
                $(".btn-delete").click(function () {
                    ...
                    btnDelete.click(function () {
                        ...
                        $("#frmDelete-TipoProcedimiento").submit();
                        return false;
                    });

                    $("#modalHeader").removeClass("btn-edit btn-show btn-delete").addClass("btn-delete");
                    $("#modalTitle").html("Eliminar Tipo Procedimiento");
                    $("#modalBody").html("<p>¿Está seguro de querer eliminar este Tipo Procedimiento?</p>");
