...
<html>
    ...
    <body>
        ...
        <g:form action="delete" name="frmDelete-tipoTramiteInstance">
            <g:hiddenField name="id"/>
        </g:form>

        <div id="list-tipoTramite" class="span12" role="main" style="margin-top: 10px;">
            ...
            <div class="pagination">
                <elm:paginate total="${tipoTramiteInstanceTotal}" params="${params}" />
            </div>
        </div>
            ...
            $(function () {
                    ...
                    $.ajax({
                        ...
                        success : function (msg) {
                            ...
                            btnSave.click(function () {
                                if ($("#frmSave-tipoTramiteInstance").valid()) {
                                    btnSave.replaceWith(spinner);
                                }
                                $("#frmSave-tipoTramiteInstance").submit();
                                return false;
                            });
                ...
                $(".btn-show").click(function () {
                    ...
                    $.ajax({
                        ...
                        success : function (msg) {
                            ...
                            $("#modalTitle").html("Ver Tipo Trámite");
                            $("#modalBody").html(msg);
                ...
                $(".btn-delete").click(function () {
                    ...
                    btnDelete.click(function () {
                        ...
                        $("#frmDelete-tipoTramiteInstance").submit();
                        return false;
                    });

                    $("#modalTitle").html("Eliminar Tipo Trámite");
                    $("#modalBody").html("<p>¿Está seguro de querer eliminar este Tipo Trámite?</p>");
